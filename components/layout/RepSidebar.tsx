...
import {
  LayoutDashboard, Package, Table2,
  LogOut, ChevronRight, BookOpen, X,
} from 'lucide-react'
...
const navItems = [
  ...
  { href: '/rep/catalogo',     label: 'Catálogo',          icon: BookOpen },
  { href: '/rep/products',     label: 'Produtos',          icon: Package },
  { href: '/rep/price-tables', label: 'Tabelas de Preço',  icon: Table2 },
]
...
export function RepSidebar({ open, onClose, userName, userRole }: RepSidebarProps) {
              ...
              {userName && (
                <div className="flex items-center gap-3 px-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#6E6E73]">{userRole ?? 'Representante'}</p>
                  </div>
                </div>
              )}
            </div>
